...
public class ExamController {
    ...
    public String sendEmail(@RequestParam(name = "id", required = true) Long id, RedirectAttributes redirectAttributes)
        ...
        for (UserExam userExam : examUsers) {
            ...
            mailMessage.setSubject("Login Credentials for " + exam_title + " Examination");
            mailMessage.setText("Dear " + user_name + ","
                    + "\n\nCritical information for taking the Online " + exam_title + " Examination "
                    + "\nLogin User Id : " + user_email
                    + "\nUser Password : " + user_pass
                    + "\nSubject Code : " + exam_code
                    + "\nDate and Time of exam : " + strDate
                    + "\n\n Please note duration of exam will be " + exam_duration
                    + " and you can only login 15 minutes prior to the exam and only till 30 minutes post start of the exam.");
